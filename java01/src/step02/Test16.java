 ...
 * => 자바스크립트와 달리 자바의 생성자는 특별한 문법을 가진다.
 * => 문법 클래스명(파라미터들){}
 * */
package step02;
...
public class Test16 {
  ...
  public static void main (String[] args){
    ...
    // 다음코드의 의미
    // 1) Student 클래스의 설계에 따라 인스턴스를 준비하라.
    // 2) Student 클래스에 정의된 메서드 중에서 다음 네 개의 값을 받을 수 있는 생성자를 호출하라.
    //    생성자를 호출하지 않을 수 있는가? 없다! 무조건 호출!
     ...
     * => 클래스와 관련된 코드는 클래스 함께 묶어 두는 것이 유지보수에 좋다.
     * => 나중에 클래스 별로 별개의 파일로 분리할 때 유리하다.
     *  유지보수 입장에서는 코드를 관리하기 쉽다.
     * */
    
    // printStudent() 메서드 또한 이 메서드와 관련된 클래스 클래스 안에 옮겨 둔다.
