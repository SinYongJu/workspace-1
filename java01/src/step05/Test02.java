...
public class Test02 {
   ...
   * 아규먼트? 메서드를 호출할 때 넘겨주는 값
   * 파라미터? 메서드가 호출될 때 넘어온 값을 받는 로컬 변수 
   * 그러나 현장에서는 두 용어를 구분 하지 않고 섞어 쓴다.*/
  public static void m2(int a,String str, boolean b){
    System.out.printf("%d, %s, %b\n",a, str, b);
  }
  
  /* 3) 값을 리턴하고, 아규먼트를 받지 않는다.
   * 메서드 서언 앞에 리턴하는 값이 어떤 타입인지 지정해야 한다.*/
  public static String m3(){
//    return 10; //String type return;
    return "Hello";
