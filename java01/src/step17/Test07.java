...
public class Test07 {
   ...
   *  => 그래서 예외 클래스의 상속관계는 이름으로 예외를 분류하는 데  의미를 두고 있다.
  ...
  public static void main(String[] args) {
    ...
    try{
      ...
      if(age < 1)
        throw new InvalidValueScopeException("나이 유효 X");
