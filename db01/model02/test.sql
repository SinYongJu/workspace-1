-- 학생
DROP TABLE IF EXISTS MY_SCHEMA.SRUD RESTRICT;
...
-- 강의배정
DROP TABLE IF EXISTS MY_SCHEMA.LECT_TCHR RESTRICT;

-- 회원
DROP TABLE IF EXISTS MY_SCHEMA.MEMB RESTRICT;

-- 학생
CREATE TABLE MY_SCHEMA.SRUD (
...
-- 학생
ALTER TABLE MY_SCHEMA.SRUD
	ADD CONSTRAINT PK_SRUD -- 학생 기본키
		PRIMARY KEY (
			MNO -- 학생번호
		);
...
CREATE TABLE MY_SCHEMA.LECT (
	...
	TOT_HRS  INTEGER NOT NULL COMMENT '총강의시간', -- 총강의시간
	DAY_THS  INTEGER NOT NULL COMMENT '일강의시간', -- 일강의시간
...
-- 강의배정
CREATE TABLE MY_SCHEMA.LECT_TCHR (
	LNO INTEGER NOT NULL COMMENT '강의번호', -- 강의번호
	MNO INTEGER NOT NULL COMMENT '강사번호' -- 강사번호
)
COMMENT '강의배정';
...
-- 강의배정
ALTER TABLE MY_SCHEMA.LECT_TCHR
...
-- 학생
ALTER TABLE MY_SCHEMA.SRUD
	ADD CONSTRAINT FK_MEMB_TO_SRUD -- 회원 -> 학생
		FOREIGN KEY (
			MNO -- 학생번호
		)
...
-- 강의수강생
ALTER TABLE MY_SCHEMA.LECT_STUD
	ADD CONSTRAINT FK_SRUD_TO_LECT_STUD -- 학생 -> 강의수강생
		FOREIGN KEY (
			MNO -- 학생번호
		)
		REFERENCES MY_SCHEMA.SRUD ( -- 학생
			MNO -- 학생번호
		);
